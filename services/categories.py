...
from schemas import Category, User, CreateCategory
...
class CategoriesService(Service):
    ...
    async def get_category_by_id(self, category_id: int, current_user: User) -> Category:
    ...
    async def get_categories(self, current_user: User) -> list[Category]:
